...
function Canvas({ shapes, tool, color, selectedId, onAddShape, onSelectShape, isEditMode }) {
  ...
  const handleMouseDown = reactExports.useCallback(
    (e) => {
      ...
      const pos = getPos(e);
      if (tool === "dot") {
        const dot = { id: nanoid(), type: "dot", x: pos.x, y: pos.y, color };
        onAddShape(dot);
        return;
      }
...
function Toolbar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#4ade80", fontSize: 12, fontWeight: 600, marginRight: 4 }, children: "EDIT" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Divider, {}),
        TOOLS.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(ToolBtn, { active: tool === t.value, onClick: () => onToolChange(t.value), children: t.label }, t.value)),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Divider, {}),
        PRESET_COLORS.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(ColorSwatch, { c, selected: color === c, onClick: () => onColorChange(c) }, c)),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Divider, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ActionBtn, { onClick: onDeleteSelected, disabled: !selectedId, title: "Delete selected (Del)", children: "Del" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ActionBtn, { onClick: onClearAll, title: "Clear all", children: "Clear" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Divider, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ActionBtn, { onClick: onSave, title: "Save (Ctrl+S)", children: "Save" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ActionBtn, { onClick: onLoad, title: "Open (Ctrl+O)", children: "Open" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Divider, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "rgba(255,255,255,0.4)", fontSize: 11 }, children: "Ctrl+Alt+Shift+1 to hide" })
      ]
    }
  );
}
function Divider() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { width: 1, height: 20, background: "rgba(255,255,255,0.15)", margin: "0 2px" } });
}
...
function useShapes() {
  ...
  const addShape = reactExports.useCallback((shape) => {
    setShapes((prev) => [...prev, shape]);
  }, []);
  const deleteShape = reactExports.useCallback((id) => {
    setShapes((prev) => prev.filter((s) => s.id !== id));
  }, []);
  const clearAll = reactExports.useCallback(() => {
    setShapes([]);
  }, []);
  const loadShapes = reactExports.useCallback((newShapes) => {
    setShapes(newShapes);
  }, []);
  return { shapes, addShape, deleteShape, clearAll, loadShapes };
}
function App() {
  const [mode, setMode] = reactExports.useState("display");
  const [tool, setTool] = reactExports.useState("circle");
  const [color, setColor] = reactExports.useState("#ff0000");
  ...
  const handleLoad = reactExports.useCallback(async () => {
